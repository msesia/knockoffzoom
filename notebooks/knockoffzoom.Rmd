...
This tutorial is intended to be exectuted on a Linux system. 
Before continuing, please ensure that the following software is available and executable.
...
Furthermore, you will need the following R packages to run `KnockoffZoom`.
